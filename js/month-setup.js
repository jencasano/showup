...
// Per-theme palettes. Each side leads with its hero red and excludes the
// other side's hero red so the lead swatch stays decisive. Side A blue
// drops on Side B (reads cool/muddy on maroon) and is replaced by a warm
// dusty rose.
const COLORS_SIDE_A = ["#C3342B", "#E8B33A", "#A65E3A", "#4F6C8E", "#5EAAA8", "#3E5C3A", "#8A6585"];
const COLORS_SIDE_B = ["#F07A5E", "#E8B33A", "#A65E3A", "#5EAAA8", "#3E5C3A", "#8A6585", "#D2937A"];

function getActivePalette() {
  const theme = document.documentElement.getAttribute("data-theme");
  return theme === "side-b" ? COLORS_SIDE_B : COLORS_SIDE_A;
}
const STICKERS = [
  "sunflower2",
  "muscle",
...
// Marker order: square (echoes the wordmark period) first, Mixtape 4-point
// sparkle second. Stored values stay "star" / "scribble" for back-compat
// with existing user selections — rename is a data migration we don't want.
const MARKERS = [
  { value: "square",   svg: `<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><rect x="7" y="7" width="10" height="10" fill="currentColor"/></svg>` },
  { value: "star",     svg: `<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M12 3 l2 5 l5 2 l-5 2 l-2 5 l-2 -5 l-5 -2 l5 -2 z" fill="currentColor"/></svg>` },
  { value: "circle",   svg: `<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><circle cx="12" cy="12" r="5" fill="currentColor"/></svg>` },
  { value: "heart",    svg: `<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M12 19s-7-4.5-7-9.5c0-2.5 2-4.5 4.5-4.5c1.5 0 2.5 0.8 2.5 2c0-1.2 1-2 2.5-2c2.5 0 4.5 2 4.5 4.5c0 5-7 9.5-7 9.5z" fill="currentColor"/></svg>` },
  { value: "check",    svg: `<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M5 12l5 5l9-10" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>` },
  { value: "x",        svg: `<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M6 6l12 12M18 6L6 18" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round"/></svg>` },
  { value: "scribble", svg: `<svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true"><path d="M3 12c2 -3 4 -3 6 0s4 3 6 0s4 -3 6 0" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/></svg>` }
];
